      ...
      <div className="w-full max-w-sm">
        <div className="bg-zs-500 rounded-t-xl px-8 py-6 flex items-center gap-3">
          ...
          <div>
            ...
            <div className="text-blue-200 text-xs">Security Key Enrollment</div>
          </div>
        </div>

        <div className="bg-white rounded-b-xl shadow-lg px-8 py-6 space-y-4">
          {done ? (
            <>
              ...
              <p className="text-sm text-gray-600">
                Sign in again using your security key to access the app.
              </p>
              <button
            ...
            <>
              <div>
                <h2 className="text-gray-700 font-semibold">Register a Security Key</h2>
                <p className="text-xs text-gray-500 mt-1">
                  Hi <span className="font-medium">{user?.username}</span>. Your account requires
                  multi-factor authentication. Register a security key or passkey to continue.
                </p>
              </div>
